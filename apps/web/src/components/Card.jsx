...
Card.Link = function CardLink({ children, ...props }) {
  return (
    <>
      <div className="absolute -inset-y-6 -inset-x-4 z-0 scale-95 bg-zinc-50 opacity-[0] transition group-hover:scale-100 group-hover:opacity-[0.35] sm:-inset-x-6 sm:rounded-2xl" />
      <Link {...props}>
